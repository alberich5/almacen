<?php
	...
	$objPHPExcel->getProperties()->setCreator("Marko robles")->setDescription("Reporte de movimientos");
	...
	while($rows = $resultado->fetch_assoc()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A'.$fila, $rows['id_movimiento']);
